...
data_dir = os.path.join(script_dir, 'shapefiles')
...
geodata_urls = [
    ...
    "https://biogeo.ucdavis.edu/data/gadm3.6/shp/gadm36_CHE_shp.zip"
]
...
for file in [f for f in os.listdir(data_dir) if f.endswith('.zip')]:
